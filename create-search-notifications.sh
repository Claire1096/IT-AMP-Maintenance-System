#!/bin/bash
set -e
mkdir -p app/Http/Controllers resources/views/components resources/views/search resources/views/employees resources/views/assets

echo 'Writing app/Http/Controllers/SearchController.php'
cat > app/Http/Controllers/SearchController.php << 'MARK1'
<?php
...
cat > resources/views/components/notification-bell.blade.php << 'MARK2'
@php
...
echo 'Writing resources/views/components/account-menu.blade.php'
cat > resources/views/components/account-menu.blade.php << 'MARK3'
<div class="relative" x-data="{ open: false }">
...
echo 'Writing resources/views/search/index.blade.php'
cat > resources/views/search/index.blade.php << 'MARK4'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
cat > resources/views/dashboard.blade.php << 'MARK5'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body class="bg-rose-50 text-gray-800 text-sm">
    ...
    <div class="bg-rose-100 border-b border-rose-200 px-6 py-3 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            <form method="GET" action="{{ route('search') }}"><input type="text" name="q" placeholder="search asset ID/Employee..." class="text-xs border-gray-300 rounded-full px-4 py-1.5 w-56"></form>
            <x-notification-bell />
            <x-account-menu />
        </div>
    </div>
...
cat > resources/views/employees/index.blade.php << 'MARK6'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
cat > resources/views/assets/create.blade.php << 'MARK7'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
cat > resources/views/assets/index.blade.php << 'MARK8'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
cat > resources/views/assets/show.blade.php << 'MARK9'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
echo 'Search + notifications + account menu all wired up!'