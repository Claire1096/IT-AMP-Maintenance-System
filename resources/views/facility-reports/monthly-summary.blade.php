...
@section('title', 'Monthly Facility Summary')
@section('content')
    <div class="no-print flex justify-between items-start mb-6">
        <div>
            <h1 class="text-lg font-bold">MONTHLY FACILITY SUMMARY</h1>
    ...
    <div class="bg-white border border-rose-100 rounded-xl p-8">
        <div class="flex flex-col items-center text-center mb-6">
            ...
            <h2 class="font-bold text-base uppercase">Monthly Facility Summary — {{ \Carbon\Carbon::create($year, $month, 1)->format('F Y') }}</h2>
        </div>
        ...
        <table class="min-w-full text-xs border-t border-gray-200">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="2" class="py-6 text-center text-gray-400">No new items registered this month.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
