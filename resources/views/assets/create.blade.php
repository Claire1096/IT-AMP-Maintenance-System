...
@section('content')
    ...
    <form method="POST" action="{{ route('assets.store') }}">
        ...
        <div class="grid grid-cols-2 gap-6 max-w-3xl">
            ...
            {{-- RIGHT PANEL: ASSIGNMENT & PURCHASE --}}
            <div class="bg-white border border-rose-100 rounded-xl p-5 shadow-sm flex flex-col justify-between">
                <div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="department_select" name="department_id" class="w-full text-xs border-gray-300 rounded-md">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="location_select" name="location_id" class="w-full text-xs border-gray-300 rounded-md">
