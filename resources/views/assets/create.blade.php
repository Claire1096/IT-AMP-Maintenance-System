            ...
            <div class="bg-white border border-rose-100 rounded-xl p-5 shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="category" value="{{ old('category') }}" required placeholder="eg. Laptops, Printers.."
                    ...
                    <div>
                        ...
                        <select name="type" class="w-full text-xs border-gray-300 rounded-md">
                            ...
                            @foreach ($assetTypes as $assetType)
                                <option value="{{ $assetType }}" @selected(old('type') === $assetType)>{{ $assetType }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
